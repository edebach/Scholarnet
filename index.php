                ...
                <ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
                        <div class="col-md-12 text-right">
                            <a class="btn btn-outline-primary" href="http://localhost:3000/login.php">Login</a>
                            <a class="btn btn-outline-secondary" href="http://localhost:3000/singup.php">Sign Up</a>
                        </div>
					</li>
                    <!-- da inserire ancora i riferimenti -->
				</ul>
