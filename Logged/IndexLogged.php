...
-->
	...
	<section id="recensione">
		<div class="container ">
			...
			<div class="row">
				<button id="insert" type="button" class="btn btn-primary" style="width: 250px;" data-toggle="modal" data-target="#recensione-popup">Inserisci la tua recensione</button>
			</div>
